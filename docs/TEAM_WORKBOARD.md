...
| P-01 | Reproduce the deepfake baseline on a fixed dataset subset | Palak | CLAIMED | `palak/deepfake-evaluation` | `docs/TEAM_WORKBOARD.md`, `docs/MODEL_EVALUATION.md`, `evaluation/deepfake/*`, `backend/tests/test_deepfake.py` | 2026-09-10 | Claimed |
